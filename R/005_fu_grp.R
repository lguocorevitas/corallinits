...
# only apply the de-duplication rule when there is more than one candidate for the same id and follow-up window
# use stop_date logic to choose one row among duplicates
